...
<p style="margin-bottom: 3px; font-size: 20px;"><b>Name:</b> <?php echo $lname.',&nbsp;' .$fname.'&nbsp;'?> <br> <b>Barangay:</b> <?php echo $barangay;?> </p>
...
<div>    
  ...
  <td><input type="text" name="date" value="<?php $date=date('d-M-y'); echo $date; ?>" /></td>
    <td></td>
       ...
       <tr>
    <td>Due Date:</td>
  <td><input type="text" name="duedate" value="" placeholder="ex. 7-Oct-17" /></td>
    <td></td>
      </tr>
      <tr>
