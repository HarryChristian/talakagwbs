...
<nav class="navbar navbar-default" style="border: 5px #0985c5; background-color: #0985c5;">
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="rbilling.php" style="color: white; background-color: #46b1e4;">Residential</a>
...
<center><strong style="font-size: 30px;">Residential Billing</strong></center>
</div>
...
<button class="btn btn-info" style="margin-right: 0px; margin-bottom: 10px; margin-left: 820px; background-color: #46b1e4;" name="submit" type="submit" id="validate">Preview Selected</button>
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="table table-hover table-bordered" id="example">
    ...
    ?>
      <tr>        
        ...
        <?php
 echo "<td style='width: 11%; text-align:center;'><a class='btn btn-primary' rel='facebox' href='paybill.php?id=".$row['id']."'>Add</a> ";
 echo "<a class='btn btn-info' rel='facebox' name='submit' id='submit' href='viewbill.php?id=".$row['id']."' style='background-color: #46b1e4;'>View</a></td>";
      ?>
