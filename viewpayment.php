...
<?php
include 'db.php';
$result = mysqli_query($con, "SELECT * FROM owners WHERE id  = '$owners_id'");
...
<p style="margin: 0px; font-size: 11px; float: left; margin-right: 310px;"><?php echo $lname; ?>, <?php echo $fname; ?></p> 
...
margin-top: 0px;">Due Date: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $date; ?></p>
